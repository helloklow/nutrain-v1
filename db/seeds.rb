...
meal_a = Meal.create!(date: "2020-04-20", 
                    ...
                    user_id: "2")
meal_b = Meal.create!(date: "2020-04-22", 
                    meal: "Lunch",
...
workout_a = Workout.create!(date: "2020-04-20",
                    exercise: "Tricep push ups",
                    reps: "20",
                    sets: "5",
                    status: "true",
                    notes: "Mix with offset push ups next time!",
                    user_id: "2")
workout_b = Workout.create!(date: "2020-04-20",
                    exercise: "Strict leg lowers",
                    reps: "20",
                    sets: "5",
                    status: "true",
                    notes: "Use 5 lb ankle weights for increased difficulty.",
                    user_id: "2")
workout_c = Workout.create!(date: "2020-04-22",
                    exercise: "Frenchies",
                    reps: "5",
                    sets: "3",
                    status: "true",
                    notes: "3 second hold each at 270, 90, and full lock off.",
                    user_id: "1")